...
def predict():
    if 'image' in request.files:
        ...
        forehead_image_path = os.path.join(os.path.dirname(__file__), "images", forehead_image_name)
        cheeks_image_name = f"{timestamp}_cheeks.jpg"
        cheeks_image_path = os.path.join(os.path.dirname(__file__), "images", cheeks_image_name)
